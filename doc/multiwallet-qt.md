...
Only requiring some minor changes is hah.cpp.
...
Changes to hah.cpp
----------------------
hah.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
