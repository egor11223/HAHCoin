...
Hah Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Hah Core, where everyone uses
...
pay attention to for reviewers of Hah Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Hah Core uses tinyformat, which is type safe. Leave them out to avoid confusion
