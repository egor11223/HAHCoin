...
This mechanism has been integrated into Bitcore-Node-Hah which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/hahpay/insight-api-hah#web-socket-api](https://github.com/hahpay/insight-api-hah#web-socket-api)
* API: [https://github.com/hahpay/insight-api-hah#instantsend-transactions](https://github.com/hahpay/insight-api-hah#instantsend-transactions)
...
By default, the Hah Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Hah Core daemon:
