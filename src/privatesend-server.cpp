...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Hah related functionality
...
/*
    ...
    allow endless transaction that would bloat Hah and make it unusable. To
