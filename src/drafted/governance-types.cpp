...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "HahNetwork") type = HahNetwork;
    if(strType == "HahNetworkVariable") type = HahNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == HahNetwork) s = "HahNetwork";
    if(type == HahNetworkVariable) s = "HahNetworkVariable";
