    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Hah Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hah address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hah: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Hah Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hah Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hah Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hah addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hah addresses"));
    ...
    openAction->setStatusTip(tr("Open a hah: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hah Core help message to get a list with possible Hah Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Hah Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hah network", "", count));
    } else {
...
{
    QString strTitle = tr("Hah Core"); // default title
